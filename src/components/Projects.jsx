...
const Projects = () => {
    ...
    // Get 3 visible projects with wrap-around
    const getVisibleProjects = () => {
        const visibleProjects = [];
        for (let i = 0; i < 3; i++) {
            const index = (currentStartIndex + i) % projects.length;
    ...
    return (
        <div className="projects-section">
            ...
            <div className="projects-carousel">
                <button className="carousel-arrow carousel-arrow-left" onClick={prevProjects}>
                ...
                <div className="projects-carousel-container">
                    <div className="projects-carousel-track">
                        {visibleProjects.map((project, index) => (
                            <div key={`${project.id}-${currentStartIndex}-${index}`} className="project-card carousel-card" onClick={() => openModal(project)}>
                ...
                <button className="carousel-arrow carousel-arrow-right" onClick={nextProjects}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
